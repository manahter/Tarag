"""
__author__    = 'Manahter'
__copyright__ = 'Copyright 2020, Tarag'

Aynı ağda bulunan diğer cihazları tarar

Methods:
    is_connection()     -> İnternete bağlı mıyız?
    find_my_ip()        -> Kendi adresimizi bul
    scan_with_arp()     -> Cihazları, sistem ARP tablosuna bakarak bulur. İletişim kurulmamış cihazları bulamaz
    scan_with_multiping()> Cihazları, tüm ip adreslerini tarayarak bulur. Ağır yöntem ama başarılı sonuç.
"""
...
# -p: process parametresi geldiyse, taramaya başla
if "-p" in sys.argv:
    scan_with_multiping()
